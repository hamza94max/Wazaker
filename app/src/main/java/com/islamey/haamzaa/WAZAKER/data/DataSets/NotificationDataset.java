...
public class NotificationDataset {
    ...
    public static String getRandomNotification() {


        String[] notifications = {"قال رسول الله صلى الله عليه وسلم: (كُلُّ أُمَّتي يَدْخُلُونَ الجَنَّةَ إِلَّا مَن أَبَى، قالوا: يا رَسُولَ اللَّهِ، وَمَن يَأْبَى؟ قالَ: مَن أَطَاعَنِي دَخَلَ الجَنَّةَ، وَمَن عَصَانِي فقَدْ أَبَى)\n" +
                "صحيح البخاري\n",
...
,
        ...
        int idx = new Random().nextInt(notifications.length);
